...
basic_files = ["if_basic_tests.yml", "cmd_var.yml", "cmd_echo_tests.yml", "cd_tests_basic.yml", "cmd_for_tests.yml", "cmd_pipe.yml", "function_basic.yml", "pipe_basic_tests.yml", "exit.yml", "export.yml"]
